export default function Header() {
  return (
    <div className="flex flex-col lg:flex-row bg-[#5383EC] text-white px-5 lg:px-24 w-full lg:h-[39rem] overflow-x-hidden">
      <div className="space-y-5 lg:space-y-8 py-24">
